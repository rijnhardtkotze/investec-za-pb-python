...
class InterAccountTransfers(BaseSDK):
    ...
    def transfer(
        ...
        *,
        ...
        transfer_list: Optional[
            Union[Iterable[models.TransferList], Iterable[models.TransferListTypedDict]]
        ] = None,
    ...
    def transfer_v2(
        ...
        *,
        ...
        transfer_list: Optional[
            Union[
                Iterable[models.Transferv2TransferList],
                Iterable[models.Transferv2TransferListTypedDict],
            ]
        ] = None,

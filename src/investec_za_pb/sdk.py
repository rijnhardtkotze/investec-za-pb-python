...
class Investec(BaseSDK):
    ...
    *   **Enhancement**: Included transaction type filter to - Get Account Transactions
    ...
    _sub_sdk_map = {
        "accounts": ("investec_za_pb.accounts", "Accounts"),
        "inter_account_transfers": (
            "investec_za_pb.interaccounttransfers",
            "InterAccountTransfers",
        ),
        "beneficiaries": ("investec_za_pb.beneficiaries", "Beneficiaries"),
        "profiles": ("investec_za_pb.profiles", "Profiles"),
        "documents": ("investec_za_pb.documents", "Documents"),
    }

...
class Documents(BaseSDK):
    ...
    ) -> models.DocumentsResponseBody:
        r"""Get Documents

        List all the documents available.

        :param account_id: AccountId Id
        :param from_date: Refers to the date range filter's start date.
        :param to_date: Refers to the date range filter's end date.

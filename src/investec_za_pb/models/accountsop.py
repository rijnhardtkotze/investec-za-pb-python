...
class AccountsAccountsTypedDict(TypedDict):
    account_id: str
...
class AccountsAccounts(BaseModel):
...
class DataTypedDict(TypedDict):
    accounts: NotRequired[List[AccountsAccountsTypedDict]]


class Data(BaseModel):
    accounts: Optional[List[AccountsAccounts]] = None
...
class AccountsResponseBodyTypedDict(TypedDict):
    r"""The requested operation was successfully completed"""
...
try:
    AccountsAccounts.model_rebuild()
except NameError:
    pass
try:
    Links.model_rebuild()

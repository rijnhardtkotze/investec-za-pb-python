...
class Transferv2TransferListTypedDict(TypedDict):
...
class Transferv2TransferList(BaseModel):
...
class Transferv2RequestBodyTypedDict(TypedDict):
    transfer_list: NotRequired[List[Transferv2TransferListTypedDict]]
    profile_id: NotRequired[str]


class Transferv2RequestBody(BaseModel):
    transfer_list: Annotated[
        Optional[List[Transferv2TransferList]], pydantic.Field(alias="transferList")
    ] = None
...
class Transferv2RequestTypedDict(TypedDict):
    account_id: str
    request_body: Transferv2RequestBodyTypedDict
...
class TransferResponsesTypedDict(TypedDict):
...
class TransferResponses(BaseModel):
...
class Transferv2DataTypedDict(TypedDict):
    ...
    transfer_responses: NotRequired[List[TransferResponsesTypedDict]]
    error_message: NotRequired[Nullable[str]]


class Transferv2Data(BaseModel):
    r"""Set of elements used to define the transfer status details."""

    transfer_responses: Annotated[
        Optional[List[TransferResponses]], pydantic.Field(alias="TransferResponses")
    ] = None
...
class Transferv2MetaTypedDict(TypedDict):
    r"""Meta Data relevant to the payload"""

    total_pages: NotRequired[int]


class Transferv2Meta(BaseModel):
    r"""Meta Data relevant to the payload"""
...
class Transferv2Links(BaseModel):
    r"""Links relevant to the payload"""

    self_: Annotated[str, pydantic.Field(alias="self")]


class Transferv2ResponseBodyTypedDict(TypedDict):
    r"""Resource has been retrieved"""

    data: Transferv2DataTypedDict
    r"""Set of elements used to define the transfer status details."""
    meta: Transferv2MetaTypedDict
    r"""Meta Data relevant to the payload"""
    links: Transferv2LinksTypedDict
    r"""Links relevant to the payload"""


class Transferv2ResponseBody(BaseModel):
    r"""Resource has been retrieved"""

...
class BeneficiariesDataTypedDict(TypedDict):
...
class BeneficiariesData(BaseModel):
...
class BeneficiariesMetaTypedDict(TypedDict):
    r"""Meta Data relevant to the payload"""

    total_pages: NotRequired[int]


class BeneficiariesMeta(BaseModel):
    r"""Meta Data relevant to the payload"""
...
class BeneficiariesLinksTypedDict(TypedDict):
    r"""Links relevant to the payload"""

    self_: str


class BeneficiariesLinks(BaseModel):
    r"""Links relevant to the payload"""

    self_: Annotated[str, pydantic.Field(alias="self")]


class BeneficiariesResponseBodyTypedDict(TypedDict):
    r"""Resource has been retrieved"""

    data: List[BeneficiariesDataTypedDict]
    r"""Set of elements used to define the beneficiaries details."""
    meta: BeneficiariesMetaTypedDict
    r"""Meta Data relevant to the payload"""
    links: BeneficiariesLinksTypedDict
    r"""Links relevant to the payload"""


class BeneficiariesResponseBody(BaseModel):
    r"""Resource has been retrieved"""

    data: List[BeneficiariesData]
    r"""Set of elements used to define the beneficiaries details."""
...
try:
    BeneficiariesData.model_rebuild()
except NameError:
    pass
try:
    BeneficiariesMeta.model_rebuild()
except NameError:
    pass
try:
    BeneficiariesLinks.model_rebuild()
except NameError:
    pass
